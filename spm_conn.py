...
class SPMConn(GPIOSPIConn):
    ...
    def _begin_message(self, length=1):
        ...
        print("Sending begin message command")
        self.send(CMD_MESSAGE_BEGIN)
        self.recv(ack=ACK_MESSAGE_BEGIN)

        print("Sending message length: %d", length)
        self.send(length)
    ...
    def noop(self):
        try:
            ...
            print("Unable to send noop: {:}".format(ex))
    ...
    def version(self):
        try:
            ...
            print("Unable to get version: {:}".format(ex))
    ...
    def status(self):
        try:
            ...
            print("Unable to get status: {:}".format(ex))
    ...
    def heartbeat_timeout(self):
        try:
            ...
            print("Unable to send heartbeat timeout: {:}".format(ex))
    ...
    def sleep_interval(self, value=None):
        try:
            if value != None:
                ...
                print("Setting sleep interval to %d second(s)", value)
            ...
            print("Unable to set sleep interval: {:}".format(ex))
    ...
    def start_3v3(self):
        try:
            ...
            print("Unable to start 3v3: {:}".format(ex))
    ...
    def stop_3v3(self):
        try:
            ...
            print("Unable to stop 3v3: {:}".format(ex))
